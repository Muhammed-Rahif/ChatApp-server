...
/*!****************************!*\
  !*** ./constants/index.ts ***!
  \****************************/
/*! exports provided: RANDOM_USER_API, DB_PATH */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RANDOM_USER_API", function() { return RANDOM_USER_API; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DB_PATH", function() { return DB_PATH; });
const RANDOM_USER_API = "https://randomuser.me/api";
const DB_PATH = "/db/index.json";
...
/*!******************************!*\
  !*** ./controllers/users.ts ***!
  \******************************/
/*! exports provided: getAllUsers, getUser, createUser, deleteUser */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getAllUsers() {
  const users = jsonfile__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(`.${_constants__WEBPACK_IMPORTED_MODULE_1__["DB_PATH"]}`);
  return users;
}
function getUser(id) {
  const users = jsonfile__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(`.${_constants__WEBPACK_IMPORTED_MODULE_1__["DB_PATH"]}`);
  const user = users.find(users => users.id == id) || null;
  return user;
}
function createUser(newUserData) {
  newUserData.id = Object(uuid__WEBPACK_IMPORTED_MODULE_2__["v4"])();
  const existingUsers = jsonfile__WEBPACK_IMPORTED_MODULE_0___default.a.readFileSync(`.${_constants__WEBPACK_IMPORTED_MODULE_1__["DB_PATH"]}`);
  existingUsers.push(newUserData);
  jsonfile__WEBPACK_IMPORTED_MODULE_0___default.a.writeFileSync(`.${_constants__WEBPACK_IMPORTED_MODULE_1__["DB_PATH"]}`, existingUsers);
  return newUserData;
}
function deleteUser(id) {
  ...
  if (userIndex !== -1) {
    ...
    jsonfile__WEBPACK_IMPORTED_MODULE_0___default.a.writeFileSync(`.${_constants__WEBPACK_IMPORTED_MODULE_1__["DB_PATH"]}`, users);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_users__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../controllers/users */ "./controllers/users.ts");
...
const resolvers = {
  ...
  Query: {
    getAllUsers: _controllers_users__WEBPACK_IMPORTED_MODULE_0__["getAllUsers"],
    getUserById: (_, {
      id
    }, __) => Object(_controllers_users__WEBPACK_IMPORTED_MODULE_0__["getUser"])(id)
  },
  Mutation: {
    createUser: (_, userData) => Object(_controllers_users__WEBPACK_IMPORTED_MODULE_0__["createUser"])(userData),
    deleteUser: (_, {
      id
    }) => Object(_controllers_users__WEBPACK_IMPORTED_MODULE_0__["deleteUser"])(id)
  },
  DeletedUser: {
    __resolveType: obj => {
...
/***/ (function(module, exports) {
    ...
    var doc = {"kind":"Document","definitions":[{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"Query"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"getAllUsers"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserData"}}}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"getUserById"},"arguments":[{"kind":"InputValueDefinition","name":{"kind":"Name","value":"id"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]}],"type":{"kind":"NamedType","name":{"kind":"Name","value":"UserData"}},"directives":[]}]},{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"Mutation"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"createUser"},"arguments":[{"kind":"InputValueDefinition","name":{"kind":"Name","value":"name"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"InputValueDefinition","name":{"kind":"Name","value":"profileImageUrl"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"InputValueDefinition","name":{"kind":"Name","value":"email"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]}],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserData"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"deleteUser"},"arguments":[{"kind":"InputValueDefinition","name":{"kind":"Name","value":"id"},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]}],"type":{"kind":"NamedType","name":{"kind":"Name","value":"DeletedUser"}},"directives":[]}]},{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"UserData"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"id"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"name"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"profileImageUrl"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"email"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]}]},{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"ErrorType"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"statusCode"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},"directives":[]},{"kind":"FieldDefinition","name":{"kind":"Name","value":"message"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},"directives":[]}]},{"kind":"UnionTypeDefinition","name":{"kind":"Name","value":"DeletedUser"},"directives":[],"types":[{"kind":"NamedType","name":{"kind":"Name","value":"UserData"}},{"kind":"NamedType","name":{"kind":"Name","value":"ErrorType"}}]},{"kind":"ObjectTypeDefinition","name":{"kind":"Name","value":"Subscription"},"interfaces":[],"directives":[],"fields":[{"kind":"FieldDefinition","name":{"kind":"Name","value":"onMessage"},"arguments":[],"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UserData"}}},"directives":[]}]}],"loc":{"start":0,"end":446}};
    doc.loc.source = {"body":"type Query {\n  getAllUsers: [UserData!]!\n  getUserById(id: ID!): UserData\n}\n\ntype Mutation {\n  createUser(name: String!, profileImageUrl: String!, email: String!): UserData!\n  deleteUser(id: ID!): DeletedUser\n}\n\ntype UserData {\n  id: ID!\n  name: String!\n  profileImageUrl: String!\n  email: String!\n}\n\ntype ErrorType {\n  statusCode: Int!\n  message: String!\n}\n\nunion DeletedUser = UserData | ErrorType\n\ntype Subscription {\n  onMessage: UserData!\n}\n","name":"GraphQL request","locationOffset":{"line":1,"column":1}};
